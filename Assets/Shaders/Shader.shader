Shader "Custom/Shader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //#include "SurfaceShaderExample6Program.hlsl"
            ...
            half4 SampleRoughness(const float2 uv) {
                return SAMPLE_TEXTURE2D(_RoughnessMap, sampler_RoughnessMap, uv);
            }

            half4 SampleOcclusion(const float2 uv) {
            ...
            void InitializeSurfaceData(const float2 uv, out SurfaceData surfaceData) {
                ...
                surfaceData.smoothness = 1 - SampleRoughness(uv).a;
